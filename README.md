...
[![Ansible Lint](https://github.com/MVladislav/ansible-cis-ubuntu-2604/actions/workflows/ansible-lint.yml/badge.svg)](https://github.com/MVladislav/ansible-cis-ubuntu-2604/actions/workflows/ansible-lint.yml)
[![Ansible Molecule Test](https://github.com/MVladislav/ansible-cis-ubuntu-2604/actions/workflows/ci.yml/badge.svg)](https://github.com/MVladislav/ansible-cis-ubuntu-2604/actions/workflows/ci.yml)

- [CIS - Ubuntu 26.04](#cis---ubuntu-2604)
  * [Ubuntu 26.04 port notes](#ubuntu-2604-port-notes)
...
This Ansible role is designed to configure **Ubuntu 26.04** to **comply** with the **CIS Ubuntu Linux 26.04 LTS Benchmark v1.0.0**. \
...
Rule IDs, titles and levels match the **CIS Ubuntu Linux 26.04 LTS Benchmark v1.0.0** XCCDF (350 rules) - see [COVERAGE-2604.md](COVERAGE-2604.md).
...
See [PORTING-2604.md](PORTING-2604.md) for what changed from the 24.04 role and why.
Inventory/AWX variables were renamed and renumbered; run
`scripts/migrate-vars-2404-to-2604.py --dry-run <group_vars>` first, then without `--dry-run`.
...
```yaml
cis_ubuntu2604_section1: true
cis_ubuntu2604_section2: true
cis_ubuntu2604_section3: true
cis_ubuntu2604_section4: true
cis_ubuntu2604_section5: true
cis_ubuntu2604_section6: true
cis_ubuntu2604_section7: true
```
...
# 'true' by default.
cis_ubuntu2604_rule_5_1_0: true
...
#  - 'cis_ubuntu2604_rule_5_1_24_ssh_pub_key' is defined or
#  - 'cis_ubuntu2604_ssh_password_authentication' is equals 'yes'
cis_ubuntu2604_rule_5_1_23: true

# Avoid SSH login lockout by specifying the user and public key for SSH access.
# Lockout will happen when 'cis_ubuntu2604_rule_5_1_19', 'cis_ubuntu2604_rule_5_1_20' and 'cis_ubuntu2604_rule_5_1_23' are used.
# Ensure that a valid SSH public key is provided, or set this rule to false.
# 'true' by default, but not executed when 'cis_ubuntu2604_rule_5_1_24_ssh_pub_key' is not defined.
cis_ubuntu2604_rule_5_1_24: true
cis_ubuntu2604_rule_5_1_24_ssh_user: "{{ ansible_user }}"
cis_ubuntu2604_rule_5_1_24_ssh_pub_key: "<ADD_PUB_KEY>"

# Set for auditd inside auditd.conf the key for 'log_file' to be save in upcoming configurations
# 'true' by default.
cis_ubuntu2604_rule_6_2_4_0: true
```
...
cis_ubuntu2604_rule_1_3_1_3: false
# Ensure all AppArmor Profiles are enforcing
# NOTE: will perform Profiles into enforcing mode
cis_ubuntu2604_rule_1_3_1_4: false

# Ensure bootloader password is set
cis_ubuntu2604_set_boot_pass: false
cis_ubuntu2604_disable_boot_pass: true

# Active journal send logs to a remote log host
# do not forget set related variables 'cis_ubuntu2604_set_journal_upload_*'
cis_ubuntu2604_set_journal_upload: false
cis_ubuntu2604_set_journal_upload_url: <SET_REMOTE_URL>

# Active rsyslog upload to remote log collection
# do not forget set related variables 'cis_ubuntu2604_set_rsyslog_remote_*'
cis_ubuntu2604_set_rsyslog_remote: false
cis_ubuntu2604_set_rsyslog_remote_target: <SET_REMOTE_URL>
```
...
cis_ubuntu2604_rule_1_1_1_9: true

# will remove bluetooth service, if bluetooth is needed set to 'false'
cis_ubuntu2604_rule_3_1_3: true
cis_ubuntu2604_rule_3_1_3_remove: true

# will disable auto mount, if auto mount is needed set to 'true'
cis_ubuntu2604_allow_autofs: false

# will purge gdm/gui, if gui is needed set to 'true'
# if 'true' is set, recommended configs will perform in rules 1.7.2 - 1.7.10
cis_ubuntu2604_allow_gdm_gui: false

# will purge printer service, if printer service is need set to 'true'
cis_ubuntu2604_allow_cups: false

# will disable ipv6 complete, if ipv6 is needed set to 'true'
cis_ubuntu2604_required_ipv6: false

# will install and config AIDE, if not needed set to 'false'
cis_ubuntu2604_install_aide: true
cis_ubuntu2604_config_aide: true
```

### Variables to check and set for own purpose

```yaml
# With rule 'cis_ubuntu2604_rule_1_1_1_10' multiple filesystem will be disabled if they are vulnerable
# if you know you would need filesystem, from vulnerable list 'cis_ubuntu2604_fs_known_vulnerable', which not listed below,
# update the list as needed.
# By default the tasks will check which filesystem are current in use and will not disable them, also if not listed in 'cis_ubuntu2604_fs_ignored'
cis_ubuntu2604_fs_ignored: # these filesystem won't be disabled
  - xfs
  - vfat
  - ext2
  - ext3
...
# list will be auto gathered if unset (cis_ubuntu2604_rule_1_3_1_3)
# you can define profiles by your own, which should be set as complain profile
cis_ubuntu2604_apparmor_update_to_complain_profiles: []
# list will be auto gathered if unset (cis_ubuntu2604_rule_1_3_1_4)
# you can define profiles by your own, which should be set as enforce profile
cis_ubuntu2604_apparmor_update_to_enforce_profiles: []

# choose time synchronization (cis_ubuntu2604_rule_2_3_1_1)
cis_ubuntu2604_time_synchronization_service: chrony # chrony | systemd-timesyncd
cis_ubuntu2604_time_synchronization_time_server:
  - uri: time.cloudflare.com
    config: iburst
  - uri: ntp.ubuntu.com
    config: iburst

# cron allow users  (cis_ubuntu2604_rule_2_4_1_8)
cis_ubuntu2604_cron_allow_users:
  - root
# at allow users  (cis_ubuntu2604_rule_2_4_2_1)
cis_ubuntu2604_at_allow_users:
  - root

# choose firewall (cis_ubuntu2604_rule_4_*)
cis_ubuntu2604_firewall: ufw # ufw | nftables | iptables
...
#cis_ubuntu2604_ssh_allow_users: root,user
#cis_ubuntu2604_ssh_allow_groups: root,ssh
#cis_ubuntu2604_ssh_deny_users: root,user
#cis_ubuntu2604_ssh_deny_groups: root,ssh

cis_ubuntu2604_ssh_permit_root_login: "no"
cis_ubuntu2604_ssh_port: 22
cis_ubuntu2604_ssh_authentication_methods: "publickey"
cis_ubuntu2604_ssh_password_authentication: "no"

# pw quality policies
cis_ubuntu2604_faillock_deny: 5
cis_ubuntu2604_faillock_unlock_time: 900
cis_ubuntu2604_faillock_minlen: 14
cis_ubuntu2604_password_complexity:
  - key: "minclass"
    value: "3"
  - key: "dcredit"
    value: "-1"
...
# journald log file rotation (cis_ubuntu2604_rule_6_1_1_3)
cis_ubuntu2604_journald_system_max_use: 4G
cis_ubuntu2604_journald_system_keep_free: 8G
cis_ubuntu2604_journald_runtime_max_use: 256M
cis_ubuntu2604_journald_runtime_keep_free: 512M
cis_ubuntu2604_journald_max_file_sec: 1month
```
...
- name: CIS | install on clients
  ...
  roles:
    - role: ansible-cis-ubuntu-2604
      ...
      cis_ubuntu2604_section7: true
      # -------------------------
      cis_ubuntu2604_rule_1_1_1_7: false # squashfs - IMPACT: Snap packages utilizes squashfs as a compressed filesystem, disabling squashfs will cause Snap packages to fail.
      # -------------------------
      cis_ubuntu2604_rule_5_1_24: true
      cis_ubuntu2604_rule_5_1_24_ssh_user: "{{ ansible_user }}"
      cis_ubuntu2604_rule_5_1_24_ssh_pub_key: "<ADD_PUB_KEY>"
      # -------------------------
      cis_ubuntu2604_rule_1_3_1_3: false # AppArmor complain mode
      cis_ubuntu2604_rule_1_3_1_4: false # AppArmor enforce mode
      # -------------------------
      cis_ubuntu2604_set_boot_pass: false # bootloader password (disabled)
      cis_ubuntu2604_disable_boot_pass: true # bootloader password (disabled with cis_ubuntu2604_set_boot_pass)
      # -------------------------
      cis_ubuntu2604_rule_3_1_3: false # bluetooth service
      cis_ubuntu2604_rule_3_1_3_remove: false # bluetooth service
      # -------------------------
      cis_ubuntu2604_allow_gdm_gui: true
      cis_ubuntu2604_allow_autofs: true # Disable auto mount, set to true to allow it and not disable
      cis_ubuntu2604_rule_1_1_1_9: false # Disable USB Storage, set to false to not disable
      cis_ubuntu2604_time_synchronization_service: chrony # chrony | systemd-timesyncd
      cis_ubuntu2604_time_synchronization_time_server:
        - uri: time.cloudflare.com
          config: iburst
        - uri: ntp.ubuntu.com
          config: iburst
      cis_ubuntu2604_allow_cups: true
      # -------------------------
      cis_ubuntu2604_install_aide: false
      cis_ubuntu2604_config_aide: false
      # -------------------------
      cis_ubuntu2604_journald_system_max_use: 4G
      cis_ubuntu2604_journald_system_keep_free: 8G
      cis_ubuntu2604_journald_runtime_max_use: 256M
      ...
      cis_ubuntu2604_journald_max_file_sec: 1month
      # -------------------------
      cis_ubuntu2604_preferred_capturing_log_method: "rsyslog"
      # -------------------------
      cis_ubuntu2604_required_ipv6: true
      ...
      cis_ubuntu2604_faillock_deny: 5
      cis_ubuntu2604_faillock_unlock_time: 900
      cis_ubuntu2604_faillock_minlen: 8
      cis_ubuntu2604_password_complexity:
        - key: "minclass"
          value: "3"
        - key: "dcredit"
